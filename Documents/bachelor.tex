...
\end{ccode}
\caption{More detailed parallel BFS}
...
For better understanding how changes in the algorithm influence the speed of the algorithm we compare the results of the different versions on Jupiter.\\
Let us start with the first version at section \ref{sec:firstversion}:
SCALE 22\\
EDGEFACTOR 4\\
\\
